package models
{
	public class Const
	{
		...
		public static const GOAL_KEEPER_BLUE_X:int = 160;
		public static const GOAL_KEEPER_BLUE_Y:int = 50;
		public static const GOAL_KEEPER_RED_X:int = 160;
		public static const GOAL_KEEPER_RED_Y:int = 400;
		
		public static const FIELD_PLAYER_BLUE1_X:int = 160;
		public static const FIELD_PLAYER_BLUE1_Y:int = 180;
		public static const FIELD_PLAYER_BLUE2_X:int = 80;
		public static const FIELD_PLAYER_BLUE2_Y:int = 140;
		public static const FIELD_PLAYER_BLUE3_X:int = 240;
		public static const FIELD_PLAYER_BLUE3_Y:int = 140;
		public static const FIELD_PLAYER_BLUE4_X:int = 160;
		public static const FIELD_PLAYER_BLUE4_Y:int = 100;
		
		public static const FIELD_PLAYER_RED1_X:int = 160;
		public static const FIELD_PLAYER_RED1_Y:int = 270;
		public static const FIELD_PLAYER_RED2_X:int = 80;
		public static const FIELD_PLAYER_RED2_Y:int = 310;
		public static const FIELD_PLAYER_RED3_X:int = 240;
		public static const FIELD_PLAYER_RED3_Y:int = 310;
		public static const FIELD_PLAYER_RED4_X:int = 160;
		public static const FIELD_PLAYER_RED4_Y:int = 350;
